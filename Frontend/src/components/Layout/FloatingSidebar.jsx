    ...
    <div className="fixed bottom-8 right-8 z-50">
      ...
      {!isOpen && (
        <button
          ...
          className="bg-indigo-600 p-4 rounded-full text-white shadow-lg hover:bg-indigo-700 transition-all duration-300 transform hover:scale-110"
      ...
      {/* Floating Menu */}
      {isOpen && (
        <div className="bg-indigo-900 rounded-lg shadow-2xl w-72 max-h-[80vh] overflow-y-auto transition-all duration-300">
          {/* Header */}
